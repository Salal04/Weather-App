...
{
    return (
        <div className=" m-2 flex p-4 box-border h-fill w-full lg:w-auto lg:flex-col bg-gray-800 shadow  items-center rounded-2xl text-white lg:justify-start justify-">
            ...
            <div  className="lg:my-5 lg:mx-0 mx-4 flex justify-center items-center flex-col">
